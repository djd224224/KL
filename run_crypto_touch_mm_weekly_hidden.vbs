' Launches run_crypto_touch_mm_weekly.ps1 with NO visible console window.
...
' Usage: wscript.exe //B run_crypto_touch_mm_weekly_hidden.vbs <MARKET> <POLLSECS>
...
cmd = "powershell.exe -NoProfile -ExecutionPolicy Bypass -File " & _
      """C:\Users\jackd\Documents\KL\run_crypto_touch_mm_weekly.ps1""" & _
