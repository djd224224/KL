...
MAX_NET_PER_MARKET = 300        # Max abs(net) contracts per market ticker
POSITION_MODERATE_THRESHOLD = 100
POSITION_STOP_THRESHOLD = 300
MAX_ORDERBOOK_LEVELS_ABOVE = 2

# [v4-4] Event-level caps
MAX_NET_PER_EVENT = 2000
...
# =====================================================================
PAIRING_MODE_THRESHOLD = 0.40   # 40% of MAX_NET = 120 contracts
PAIRING_MODE_AGGRESSIVE = 0.75  # 75% of MAX_NET = 225 contracts
PAIRING_MODE_NET_FLOOR = 120    # Absolute floor (= MAX_NET * 0.40)
PAIRING_MODE_NET_AGGRESSIVE = 225  # Absolute aggressive (= MAX_NET * 0.75)
...
MAX_PAIRED_PER_MARKET = 500     # Don't over-concentrate paired positions
...
def place_orders_from_df(df_results: pd.DataFrame):
    ...
    print(f"\n{'='*70}")
    print(f"PREPARED {len(all_orders)} POST-ONLY LIMIT ORDERS (v4.2)")
    print(f"{'='*70}")
